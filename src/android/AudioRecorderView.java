...
public class AudioRecorderView extends RelativeLayout {
    ...
    private static int DEFAULT_VIEW_COLORS = Color.RED;
    ...
    private OnClickListener onClickListenerStartRecord = new OnClickListener() {
        ...
        public void onClick(final View v) {
            ...
            if (!isRecording) {
                vibrate();
                setStopImageDrawable(v, R.drawable.ic_stop_audio, colorView);
    ...
    private OnClickListener onClickListenerRejectAudio = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            setStopImageDrawable(findViewById(R.id.img_button_play), R.drawable.ic_play_arrow_audio, colorView);
    ...
    private void stopRecord (ImageButton imageButton) {
        ...
        if(imageButton != null)
            setStopImageDrawable(imageButton, R.drawable.ic_mic_audio, colorView);
    ...
    private void stopMediaPlayer (ImageButton imageButton) {
        if(mPlayer != null) {
            ...
            if(imageButton != null)
                setStopImageDrawable(imageButton, R.drawable.ic_play_arrow_audio, colorView);
        }
    }
     ...
     * @param color
     */
    private void setStopImageDrawable(View v, int res, int color) {
        PorterDuff.Mode mMode = PorterDuff.Mode.MULTIPLY;
        Drawable dr = getResources().getDrawable(res);
        dr.setColorFilter(color, mMode);
        ((ImageButton) v).setImageDrawable(createSelectorIconApplications(dr));
    }
